VIDEO_CHATTER_META_SUMMARY_SYSTEM_TEMPLATE = """
    ...
    In addition, also provide a conceptual framework that captures the themes that are represented in the students' conversations in the form of a markdown block with headings and subheadings. Include 10-15 #tags at the end that represent the main topics and concepts. 
