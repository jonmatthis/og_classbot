...
async def generate_student_summaries(mongo_database: MongoDatabaseManager,
    ...
    with get_openai_callback() as cb:
        for student_number, student_username in enumerate(student_usernames):
            ...
            await mongo_database.upsert(collection=student_summaries_collection_name,
    ...
    await mongo_database.save_json(collection_name=student_summaries_collection_name, )
